...
func (f *Flags) printConfigurationUsage() string {
	...
	commands := []struct {
		...
		{utils.SubCommandCIRA, "Configure CIRA. Enable/Disable CIRA. Requires AMT password.", baseCommand + " " + utils.SubCommandCIRA + " -mpspassword YourMPSPassword -mpsaddress myfqdn.com:1433"},
	}
