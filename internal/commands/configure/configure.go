...
type ConfigureCmd struct {
	...
	EnableAMT   EnableAMTCmd    `cmd:"" aliases:"enable,enableamt" help:"Enable AMT operational state (requires unprovisioned state)"`
	DisableAMT  DisableAMTCmd   `cmd:"" aliases:"disable,disableamt" help:"Disable AMT operational state (requires unprovisioned state)"`
