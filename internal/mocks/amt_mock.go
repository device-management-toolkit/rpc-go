...
import (
	...
	psr "github.com/device-management-toolkit/rpc-go/v2/pkg/psr"
...
// GetPSR mocks base method.
func (m *MockInterface) GetPSR() (*psr.PSR, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPSR")
	ret0, _ := ret[0].(*psr.PSR)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPSR indicates an expected call of GetPSR.
func (mr *MockInterfaceMockRecorder) GetPSR() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPSR", reflect.TypeOf((*MockInterface)(nil).GetPSR))
}
